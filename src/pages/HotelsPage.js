  ...
  return (
    <div className="hotels-container">
      ...
      <p className="hotels-description">
        Chaque hôtel a été soigneusement sélectionné pour vous offrir un service de qualité, des chambres confortables et une ambiance unique.
        Faites défiler la liste ci-dessous pour découvrir celui qui vous correspond le mieux !
      </p>
